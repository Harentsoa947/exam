...
@section('contenue-admin')
    <div class=" py-3 min-h-[101vh]">
        <div class="flex gap-3 items-center my-2">
            <a href="{{ route('prof.examen.web.pointiller', $examen->id) }}" 
        ...
        <div class="border border-black/5 mt-2">
            <div class="flex justify-between gap-5 border-b-2 border-black/10 p-2 bg-black/3 ">
                ...
                <div class="">
                    <a href="{{ route('prof.examen.web.pointiller.question.create', [$examen->id, $pointillerWeb->id]) }}" 
                    ...
                    <div class="border-b border-black/3">
                        ...
                        <div class="flex gap-5 justify-between py-2">
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <form action="{{ route('prof.examen.web.pointiller.question.destroy', [$examen->id, $pointillerWeb->id, $question->id]) }}" 
