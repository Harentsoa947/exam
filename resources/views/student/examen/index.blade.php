            ...
            <div class="flex-1 w-[17cm] m-auto border border-black/10 rounded-md bg-black/2">
                ...
                <div class="flex-1 text-center p-15 pt-0">
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <div class="border border-black/10 rounded-sm px-3 py-1">
                            <span class="text-rouge">{{ $examen->types_exercice_count }}</span> Types d'exercice
                        </div>
                        <div class="border border-black/10 rounded-sm px-3 py-1">
                            Date d'examen: {{ $examen->pivot->date_debut
                                ? \Carbon\Carbon::parse($examen->pivot->date_debut)->format('d/m/Y')
                                : 'Non planifié' }}
                        </div>
                    </div>
